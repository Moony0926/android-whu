...
import org.whu.DatabaseErrorHandler;
import org.whu.DefaultDatabaseErrorHandler;
import org.whu.database.SQLiteDatabaseConfiguration;
import org.whu.database.SQLiteDebug;
import org.whu.database.SQLiteDirectCursorDriver;
import org.whu.database.SQLiteGlobal;
import org.whu.database.SQLiteSession;
...
public final class SQLiteDatabase extends SQLiteClosable {
    ...
    static {
        System.loadLibrary("android_whu");
    }
    ...
    private final org.whu.database.CloseGuard mCloseGuardLocked = org.whu.database.CloseGuard.get();
    ...
    // INVARIANT: Guarded by mLock.
    private org.whu.database.SQLiteConnectionPool mConnectionPoolLocked;
    ...
    private void dispose(boolean finalized) {
        final org.whu.database.SQLiteConnectionPool pool;
        synchronized (mLock) {
    ...
    int getThreadDefaultConnectionFlags(boolean readOnly) {
        int flags = readOnly ? org.whu.database.SQLiteConnectionPool.CONNECTION_FLAG_READ_ONLY :
                org.whu.database.SQLiteConnectionPool.CONNECTION_FLAG_PRIMARY_CONNECTION_AFFINITY;
        if (isMainThread()) {
            flags |= org.whu.database.SQLiteConnectionPool.CONNECTION_FLAG_INTERACTIVE;
        }
        return flags;
    }
    ...
    private void openInner() {
        synchronized (mLock) {
            ...
            mConnectionPoolLocked = org.whu.database.SQLiteConnectionPool.open(mConfigurationLocked);
    ...
    public void addCustomFunction(String name, int numArgs, CustomFunction function) {
        ...
        org.whu.database.SQLiteCustomFunction wrapper = new org.whu.database.SQLiteCustomFunction(name, numArgs, function);
    ...
    static boolean hasCodec() {
        return org.whu.database.SQLiteConnection.hasCodec();
    }
