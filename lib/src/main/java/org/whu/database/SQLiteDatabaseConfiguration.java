...
public final class SQLiteDatabaseConfiguration {
     ...
     */
    public @org.whu.database.SQLiteDatabase.OpenFlags int openFlags;
     ...
     */
    public final List<org.whu.database.SQLiteCustomFunction> customFunctions = new ArrayList<>();

    /**
     * The custom extensions to register.
     */
    public final List<org.whu.database.SQLiteCustomExtension> customExtensions = new ArrayList<>();
     ...
     */
    public SQLiteDatabaseConfiguration(String path, @org.whu.database.SQLiteDatabase.OpenFlags int openFlags) {
        if (path == null) {
    ...
    public SQLiteDatabaseConfiguration(String path,
                                       @org.whu.database.SQLiteDatabase.OpenFlags int openFlags,
                                       List<org.whu.database.SQLiteCustomFunction> functions,
                                       List<org.whu.database.SQLiteCustomExtension> extensions) {
        this(path, openFlags);
