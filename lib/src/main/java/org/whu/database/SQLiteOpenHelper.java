...
public abstract class SQLiteOpenHelper {
            ...
            if (db != null) {
                ...
                try {
                    ...
                    if (DEBUG_STRICT_READONLY && !writable) {
                        org.whu.database.SQLiteDatabaseConfiguration configuration =
     ...
     */
    protected org.whu.database.SQLiteDatabaseConfiguration createConfiguration(String path,
                                                                               @org.whu.database.SQLiteDatabase.OpenFlags int openFlags) {
        return new org.whu.database.SQLiteDatabaseConfiguration(path, openFlags);
    }
}
