...
public final class SQLiteSession {
    private final org.whu.database.SQLiteConnectionPool mConnectionPool;

    private org.whu.database.SQLiteConnection mConnection;
     ...
     */
    public SQLiteSession(org.whu.database.SQLiteConnectionPool connectionPool) {
