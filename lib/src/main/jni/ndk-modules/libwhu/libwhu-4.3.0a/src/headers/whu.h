...
/**
 ...
 Main Whu header file
 */
#ifndef DOXYGEN_SHOULD_SKIP_THIS
#ifdef _WIN32
#ifdef DLL_EXPORT
#define WHU_DECLARE __declspec(dllexport)
#else
#define WHU_DECLARE extern
#endif
#else
#define WHU_DECLARE __attribute__ ((visibility("default")))
#endif
#endif
...
#include <whu/gaiageo.h>

#ifdef LOADABLE_EXTENSION
    WHU_DECLARE int
	sqlite3_whu_init (sqlite3 * db, char **pzErrMsg,
...
/**
 ...
 before attempting to call any Whu own function.
 */
    WHU_DECLARE void whu_initialize (void);
 ...
 */
    WHU_DECLARE void whu_shutdown (void);
 ...
 */
    WHU_DECLARE const char *whu_version (void);
 ...
 */
    WHU_DECLARE const char *whu_target_cpu (void);

/**
 Initializes the internal memory block supporting each connection

 \sa whu_init_ex, whu_cleanup_ex

 */
    WHU_DECLARE void *whu_alloc_connection (void);

/**
 Initializes a Whu connection.

 This function is now \b DEPRECATED because is not reentrant (not thread safe);
 use whu_init_ex() for all new development.

 \param verbose if TRUE a short start-up message is shown on stderr

 \sa whu_cleanup, whu_init_ex

 \note You absolutely must invoke this function before attempting to perform
 any other Whu's call.

 */
    WHU_DECLARE void whu_init (int verbose);

/**
 Initializes a Whu connection.

 \param db_handle handle to the current SQLite connection
 \param ptr a memory pointer returned by whu_alloc_connection()
 \param verbose if TRUE a short start-up message is shown on stderr

 \sa whu_alloc_connection, whu_cleanup_ex, whu_init

 \note You absolutely must invoke this function before attempting to perform
 any other Whu's call.

 */
    WHU_DECLARE void whu_init_ex (sqlite3 * db_handle,
 ...
 */
    WHU_DECLARE void whu_init_geos (void);

/**
 Cleanup a Whu connection

 This function is now \b DEPRECATED; use whu_cleanup_ex() for all new development.
 ...
 \sa whu_init
*/
    WHU_DECLARE void whu_cleanup (void);
...
/**
 ...
 whu_init_ex() and returned by whu_alloc_connection()

 \sa whu_init_ex, whu_alloc_connection
*/
    WHU_DECLARE void whu_cleanup_ex (const void *ptr);
 ...
 */
    WHU_DECLARE int dump_shapefile (sqlite3 * sqlite, char *table,
 ...
 */
    WHU_DECLARE int load_shapefile (sqlite3 * sqlite, char *shp_path,
 ...
 */
    WHU_DECLARE int load_shapefile_ex (sqlite3 * sqlite, char *shp_path,
...
/**
 ...
 \n Anyway, declaring a mismatching geometry type will surely cause a failure.
 */
    WHU_DECLARE int load_shapefile_ex2 (sqlite3 * sqlite, char *shp_path,
					       char *table, char *charset,
					       int srid, char *geo_column,
					       char *gtype, char *pk_column,
					       int coerce2d, int compressed,
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int load_dbf (sqlite3 * sqlite, char *dbf_path,
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int load_dbf_ex (sqlite3 * sqlite, char *dbf_path,
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int load_dbf_ex2 (sqlite3 * sqlite, char *dbf_path,
					 char *table, char *pk_column,
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int dump_dbf (sqlite3 * sqlite, char *table,
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int dump_dbf_ex (sqlite3 * sqlite, char *table,
					char *dbf_path, char *charset,
					int *rows, char *err_msg);
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int load_XL (sqlite3 * sqlite, const char *path,
				    const char *table,
 ...
 */
    WHU_DECLARE double math_round (double value);
 ...
 */
    WHU_DECLARE sqlite3_int64 math_llabs (sqlite3_int64 value);
 ...
 */
    WHU_DECLARE int spatial_ref_sys_init (sqlite3 * sqlite, int verbose);
...
/**
 ...
 \note this function is internally invoked by the SQL function 
  InitSpatialMetadata(), and is not usually intended for direct use.
 */
    WHU_DECLARE int spatial_ref_sys_init2 (sqlite3 * sqlite, int mode,
						  int verbose);
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int insert_epsg_srid (sqlite3 * sqlite, int srid);
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int srid_is_geographic (sqlite3 * sqlite, int srid,
					       int *geographic);
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int srid_is_projected (sqlite3 * sqlite, int srid,
					      int *projected);
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int srid_has_flipped_axes (sqlite3 * sqlite, int srid,
						  int *flipped);
 ...
 */
    WHU_DECLARE char *srid_get_spheroid (sqlite3 * sqlite, int srid);
...
/**
 ...
 \note you are responsible for freeing the returned name.
 */
    WHU_DECLARE char *srid_get_prime_meridian (sqlite3 * sqlite,
						      int srid);
...
/**
 ...
 \note you are responsible for freeing the returned name.
 */
    WHU_DECLARE char *srid_get_projection (sqlite3 * sqlite, int srid);
...
/**
 ...
 \note you are responsible for freeing the returned name.
 */
    WHU_DECLARE char *srid_get_datum (sqlite3 * sqlite, int srid);
...
/**
 ...
 \note you are responsible for freeing the returned name.
 */
    WHU_DECLARE char *srid_get_unit (sqlite3 * sqlite, int srid);
...
/**
 ...
 \note you are responsible for freeing the returned name.
 */
    WHU_DECLARE char *srid_get_axis (sqlite3 * sqlite, int srid,
					    char axis, char mode);
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int dump_kml (sqlite3 * sqlite, char *table,
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int dump_kml_ex (sqlite3 * sqlite, char *table,
					char *geom_col, char *kml_path,
					char *name_col, char *desc_col,
 ...
 */
    WHU_DECLARE void check_duplicated_rows (sqlite3 * sqlite,
						   char *table,
						   int *dupl_count);
 ...
 */
    WHU_DECLARE void remove_duplicated_rows (sqlite3 * sqlite,
						    char *table);
...
/**
 ...
 will be preserved, then deleting any further occurrence.
 */
    WHU_DECLARE void remove_duplicated_rows_ex (sqlite3 * sqlite,
						       char *table,
						       int *removed);
...
/**
 ...
 will be preserved, then deleting any further occurrence.
 */
    WHU_DECLARE void remove_duplicated_rows_ex2 (sqlite3 * sqlite,
							char *table,
							int *removed,
							int transaction);
 ...
 */
    WHU_DECLARE void elementary_geometries (sqlite3 * sqlite,
						   char *inTable,
						   char *geometry,
...
/**
 ...
 the same value in the "multiId" column.
 */
    WHU_DECLARE void elementary_geometries_ex (sqlite3 * sqlite,
						      char *inTable,
						      char *geometry,
						      char *outTable,
...
/**
 ...
 the same value in the "multiId" column.
 */
    WHU_DECLARE void elementary_geometries_ex2 (sqlite3 * sqlite,
						       char *inTable,
						       char *geometry,
						       char *outTable,
						       char *pKey,
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int dump_geojson (sqlite3 * sqlite, char *table,
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int dump_geojson_ex (sqlite3 * sqlite, char *table,
					    char *geom_col, char *outfile_path,
					    int precision, int option,
					    int *rows);
 ...
 */
    WHU_DECLARE int update_layer_statistics (sqlite3 * sqlite,
						    const char *table,
						    const char *column);
 ...
 */
    WHU_DECLARE int gaiaStatisticsInvalidate (sqlite3 * handle,
						     const char *table,
						     const char *geometry);
 ...
 */
    WHU_DECLARE gaiaGeomCollPtr gaiaGetLayerExtent (sqlite3 * handle,
							   const char *table,
							   const char *geometry,
							   int mode);
...
/**
 ...
 \n If the mode arg is set to GAIA_VECTORS_LIST_PESSIMISTIC a preliminary attempt to update the
  statistic tables will be always performed (probably slower, but surely accurate).
 */
    WHU_DECLARE gaiaVectorLayersListPtr gaiaGetVectorLayersList (sqlite3
									*
									handle,
									const
									char
 ...
 */
    WHU_DECLARE int gaiaCreateMetaCatalogTables (sqlite3 * handle);
 ...
 */
    WHU_DECLARE int gaiaUpdateMetaCatalogStatistics (sqlite3 * handle,
							    const char *table,
							    const char *column);
 ...
 */
    WHU_DECLARE int gaiaUpdateMetaCatalogStatisticsFromMaster (sqlite3 *
								      handle,
								      const char
								      *master_table,
								      const char
 ...
 */
    WHU_DECLARE void gaiaFreeVectorLayersList (gaiaVectorLayersListPtr
						      ptr);
 ...
 */
    WHU_DECLARE int gaiaDropTable (sqlite3 * sqlite, const char *table);
...
/**
 ...
 \sa gaiaDropTableEx2
 */
    WHU_DECLARE int gaiaDropTableEx (sqlite3 * sqlite,
					    const char *prefix,
					    const char *table);
...
/**
 ...
 \sa gaiaDropTable
 */
    WHU_DECLARE int gaiaDropTableEx2 (sqlite3 * sqlite,
					     const char *prefix,
					     const char *table,
					     int transaction);
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int check_geometry_column (sqlite3 * sqlite,
						  const char *table,
						  const char *geom,
...
/**
 ...
 \param p_cache a memory pointer returned by whu_alloc_connection()
 \param sqlite handle to current DB connection
 \param table name of the table 
 \param geometry name of the column to be checked
 \param report_path pathname of the report-file
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int check_geometry_column_r (const void *p_cache,
						    sqlite3 * sqlite,
						    const char *table,
						    const char *geom,
						    const char *report_path,
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int check_all_geometry_columns (sqlite3 * sqlite,
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int check_all_geometry_columns_r (const void *p_cache,
							 sqlite3 * sqlite,
							 const char *output_dir,
							 int *n_invalids,
							 char **err_msg);
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int sanitize_geometry_column (sqlite3 * sqlite,
						     const char *table,
						     const char *geom,
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int sanitize_geometry_column_r (const void *p_cache,
						       sqlite3 * sqlite,
						       const char *table,
						       const char *geom,
						       const char *tmp_table,
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int sanitize_all_geometry_columns (sqlite3 * sqlite,
							  const char
							  *tmp_prefix,
							  const char
							  *output_dir,
...
/**
 ...
 \return 0 on failure, any other value on success
 */
    WHU_DECLARE int sanitize_all_geometry_columns_r (const void *p_cache,
							    sqlite3 * sqlite,
							    const char
							    *tmp_prefix,
							    const char
    ...
    WHU_DECLARE int gaiaGPKG2Whu (sqlite3 * handle_in,
						const char *gpkg_in_path,
						sqlite3 * handle_out,
						const char *splite_out_path);
    WHU_DECLARE int gaiaWhu2GPKG (sqlite3 * handle_in,
