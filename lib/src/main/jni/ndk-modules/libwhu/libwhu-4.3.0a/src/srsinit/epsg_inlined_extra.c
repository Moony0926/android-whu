...
WHU_PRIVATE void initialize_epsg_00 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_01 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_02 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_03 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_04 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_05 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_06 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_07 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_08 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_09 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_10 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_11 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_12 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_13 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_14 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_15 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_16 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_17 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_18 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_19 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_20 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_21 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_22 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_23 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_24 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_25 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_26 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_27 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_28 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_29 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_30 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_31 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_32 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_33 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_34 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_35 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_36 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_37 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_38 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_39 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_40 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_41 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_42 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_43 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_44 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_45 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_46 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_wgs84_00 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
WHU_PRIVATE void initialize_epsg_wgs84_01 (
	int filter, struct epsg_defs **first, struct epsg_defs **last);
