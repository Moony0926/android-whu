 ...
 */
    WHU_DECLARE int load_from_wfs (sqlite3 * sqlite,
 ...
 */
    WHU_DECLARE int load_from_wfs_paged (sqlite3 * sqlite,
						const char *path_or_url,
						const char *alt_describe_uri,
 ...
 */
    WHU_DECLARE gaiaWFScatalogPtr create_wfs_catalog (const char
							     *path_or_url,
							     char **err_msg);
 ...
 */
    WHU_DECLARE void destroy_wfs_catalog (gaiaWFScatalogPtr handle);
...
/**
 ...
 \sa create_wfs_catalog
 */
    WHU_DECLARE const char *get_wfs_version (gaiaWFScatalogPtr handle);
 ...
 */
    WHU_DECLARE const char *get_wfs_base_request_url (gaiaWFScatalogPtr
							     handle);
 ...
 */
    WHU_DECLARE const char *get_wfs_base_describe_url (gaiaWFScatalogPtr
							      handle);
 ...
 */
    WHU_DECLARE char *get_wfs_request_url (gaiaWFScatalogPtr handle,
						  const char *name,
						  const char *version,
 ...
 */
    WHU_DECLARE char *get_wfs_describe_url (gaiaWFScatalogPtr handle,
						   const char *name,
						   const char *version);
 ...
 */
    WHU_DECLARE int get_wfs_catalog_count (gaiaWFScatalogPtr handle);
 ...
 */
    WHU_DECLARE gaiaWFSitemPtr get_wfs_catalog_item (gaiaWFScatalogPtr
							    handle, int index);
...
/**
 ...
 get_wfs_keyword_count, get_wfs_keyword
 */
    WHU_DECLARE const char *get_wfs_item_name (gaiaWFSitemPtr handle);
...
/**
 ...
 get_wfs_keyword_count, get_wfs_keyword
 */
    WHU_DECLARE const char *get_wfs_item_title (gaiaWFSitemPtr handle);
...
/**
 ...
 get_wfs_keyword_count, get_wfs_keyword
 */
    WHU_DECLARE const char *get_wfs_item_abstract (gaiaWFSitemPtr
							  handle);
 ...
 */
    WHU_DECLARE int get_wfs_layer_srid_count (gaiaWFSitemPtr handle);
 ...
 */
    WHU_DECLARE int get_wfs_layer_srid (gaiaWFSitemPtr handle,
					       int index);
 ...
 */
    WHU_DECLARE int get_wfs_keyword_count (gaiaWFSitemPtr handle);
...
/**
 ...
 get_wfs_layer_srid_count, get_wfs_layer_srid, get_wfs_layer_keyword
 */
    WHU_DECLARE const char *get_wfs_keyword (gaiaWFSitemPtr handle,
						    int index);
 ...
 */
    WHU_DECLARE gaiaWFSschemaPtr create_wfs_schema (const char
							   *path_or_url,
							   const char
							   *layer_name,
							   char **err_msg);
 ...
 */
    WHU_DECLARE void destroy_wfs_schema (gaiaWFSschemaPtr handle);
 ...
 */
    WHU_DECLARE int get_wfs_schema_geometry_info (gaiaWFSschemaPtr
							 handle,
							 const char **name,
							 int *type, int *srid,
							 int *dims,
 ...
 */
    WHU_DECLARE int get_wfs_schema_column_count (gaiaWFSschemaPtr
							handle);
 ...
 */
    WHU_DECLARE gaiaWFScolumnPtr get_wfs_schema_column (gaiaWFSschemaPtr
							       handle,
							       int index);
 ...
 */
    WHU_DECLARE int get_wfs_schema_column_info (gaiaWFScolumnPtr handle,
						       const char **name,
						       int *type,
						       int *nullable);
 ...
 */
    WHU_DECLARE void reset_wfs_http_connection (void);
