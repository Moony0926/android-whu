...
/**
 ...
 \sa gaiaFreeGeomColl, gaiaToWhuBlobWkb, gaiaToCompressedBlobWkb,
 gaiaFromWhuBlobWkbEx
 ...
 */
    GAIAGEO_DECLARE gaiaGeomCollPtr gaiaFromWhuBlobWkb (const unsigned
							       char *blob,
							       unsigned int
							       size);
...
/**
 ...
 \param gpkg_amphibious is set to TRUE will indifferenctly accept
  either Whu Geometry-BLOBs or GPKG Geometry-BLOBs
 ...
 contained child object. 
 */
    GAIAGEO_DECLARE gaiaGeomCollPtr gaiaFromWhuBlobWkbEx (const unsigned
								 char *blob,
								 unsigned int
								 size,
								 int gpkg_mode,
...
/**
 ...
 \sa gaiaFromWhuBlobWkb, gaiaToCompressedBlobWkb

 \note the BLOB buffer corresponds to dynamically allocated memory:
 so you are responsible to free() it [unless SQLite will take care
 of memory cleanup via buffer binding].
 */
    GAIAGEO_DECLARE void gaiaToWhuBlobWkb (gaiaGeomCollPtr geom,
...
/**
 ...
 of memory cleanup via buffer binding].
 */
    GAIAGEO_DECLARE void gaiaToWhuBlobWkbEx (gaiaGeomCollPtr geom,
						    unsigned char **result,
...
/**
 ...
 \sa gaiaFromWhuBlobWkb, gaiaToWhuBlobWkb
...
/**
 ...
 Whu: not necessarily intended by other OGC-like implementations.
