...
/*
 * Helper function that will create any type of polygon (xy, xym, xyz, xyzm) in Whu.
 * 
...
/* 
 * Creates a 2D (xy) polygon in Whu
 *
 * first is a gaiaRingPtr to the first ring in a linked list of rings which define the polygon.
 * The first ring in the linked list is the external ring while the rest (if any) are internal rings.
...
/* 
 * Creates a 3D (xyz) polygon in Whu
 *
 * first is a gaiaRingPtr to the first ring in a linked list of rings which define the polygon.
 * The first ring in the linked list is the external ring while the rest (if any) are internal rings.
...
/* 
 * Creates a 2D (xym) polygon in Whu
 *
 * first is a gaiaRingPtr to the first ring in a linked list of rings which define the polygon.
 * The first ring in the linked list is the external ring while the rest (if any) are internal rings.
...
/* 
 * Creates a 3D (xyzm) polygon in Whu
 *
 * first is a gaiaRingPtr to the first ring in a linked list of rings which define the polygon.
 * The first ring in the linked list is the external ring while the rest (if any) are internal rings.
 ...
 * NOTE: This function may already be implemented in the Whu code base. If it is, make sure that we
...
/* 
 * Creates a 2D (xy) multipoint object in Whu
 *
...
/* 
 * Creates a 3D (xyz) multipoint object in Whu
 *
 * first is a gaiaPointPtr to the first point in a linked list of points.
...
/* 
 * Creates a 2D (xym) multipoint object in Whu
 *
 * first is a gaiaPointPtr to the first point in a linked list of points.
...
/* 
 * Creates a 3D (xyzm) multipoint object in Whu
 *
...
/* Creates a 2D (xy) geometry collection in Whu
 *
