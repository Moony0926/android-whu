...
#include <whu/sqlite.h>
#include <whu/debug.h>
#include <whu/gaiaaux.h>

#include <whu.h>
#include <whu_private.h>
...
/* checking if already exists */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("registerExternalGraphic: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
	...
	whu_e ("registerExternalGraphic() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
    return retval;
  stop:
...
/* checking if already exists */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("unregisterExternalGraphic: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
	...
	whu_e ("unregisterExternalGraphic() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
    return retval;
  stop:
...
/* auxiliary function: checks for an eventual duplicate name */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("VectorStyle duplicate Name: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  return 0;
      }
    sqlite3_reset (stmt);
...
/* auxiliary function: inserts a Vector Style definition */
    ...
    if (p_blob != NULL && n_bytes > 0)
	  ...
	  if (ret == SQLITE_DONE || ret == SQLITE_ROW)
	    ...
	    {
		whu_e ("registerVectorStyle() error: \"%s\"\n",
			      sqlite3_errmsg (sqlite));
		sqlite3_finalize (stmt);
		return 0;
	    }
...
/* checks if a Vector Style do actually exists - by ID */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Vector Style by ID: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* checks if a Vector Style do actually exists - by name */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Vector Style by Name: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* checks if a Vector Style do actually exists - by ID */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Vector Style Refs by ID: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* checks if a Vector Style do actually exists - by name */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Vector Style Refs by Name: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* auxiliary function: really inserting a Vector Styled Layer */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("registerVectorStyledLayer: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
	...
	whu_e ("registerVectorStyledLayer() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
    return retval;
  stop:
...
/* auxiliary function: deleting all Vector Style references */
	...
	whu_e ("unregisterVectorStyle() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
    return retval;
  stop:
...
/* auxiliary function: reloads a Vector Style definition */
    ...
    if (p_blob != NULL && n_bytes > 0)
	  ...
	  if (ret == SQLITE_DONE || ret == SQLITE_ROW)
	    ...
	    {
		whu_e ("reloadVectorStyle() error: \"%s\"\n",
			      sqlite3_errmsg (sqlite));
		sqlite3_finalize (stmt);
		return 0;
	    }
...
/* checks if a Vector Styled Layer do actually exists - by ID */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Vector Styled Layer by ID: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* checks if a Vector Styled Layer do actually exists - by name */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Vector Styled Layer by Name: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* auxiliary function: really deleting a Vector Styled Layer */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("unregisterVectorStyledLayer: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
	...
	whu_e ("unregisterVectorStyledLayer() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
    return retval;
  stop:
...
/* auxiliary function: checks for an eventual duplicate name */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("RasterStyle duplicate Name: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  return 0;
      }
    sqlite3_reset (stmt);
...
/* auxiliary function: inserts a Raster Style definition */
    ...
    if (p_blob != NULL && n_bytes > 0)
	  ...
	  if (ret == SQLITE_DONE || ret == SQLITE_ROW)
	    ...
	    {
		whu_e ("registerRasterStyle() error: \"%s\"\n",
			      sqlite3_errmsg (sqlite));
		sqlite3_finalize (stmt);
		return 0;
	    }
...
/* auxiliary function: deleting all Raster Style references */
	...
	whu_e ("unregisterRasterStyle() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
    return retval;
  stop:
...
/* checks if a Raster Style do actually exists - by ID */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Raster Style Refs by ID: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* checks if a Raster Style do actually exists - by name */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Raster Style Refs by Name: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* checks if a Raster Style do actually exists - by ID */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Raster Style by ID: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* checks if a Raster Style do actually exists - by name */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Raster Style by Name: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* auxiliary function: reloads a Raster Style definition */
    ...
    if (p_blob != NULL && n_bytes > 0)
	  ...
	  if (ret == SQLITE_DONE || ret == SQLITE_ROW)
	    ...
	    {
		whu_e ("reloadRasterStyle() error: \"%s\"\n",
			      sqlite3_errmsg (sqlite));
		sqlite3_finalize (stmt);
		return 0;
	    }
...
/* auxiliary function: really inserting a Raster Styled Layer */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("registerRasterStyledLayer: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
	...
	whu_e ("registerRasterStyledLayer() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
    return retval;
  stop:
...
/* checks if a Raster Styled Layer do actually exists - by ID */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Raster Styled Layer by ID: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* checks if a Raster Styled Layer do actually exists - by name */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Raster Styled Layer by Name: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* auxiliary function: really deleting a Raster Styled Layer */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("unregisterRasterStyledLayer: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
	...
	whu_e ("unregisterRasterStyledLayer() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
    return retval;
  stop:
...
/* inserting a Styled Group */
	...
	whu_e ("insertStyledGroup() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
    return retval;
}
...
/* auxiliary function: inserts a Styled Group Item */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("registerStyledGroupsRefs: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
	...
	whu_e ("registerStyledGroupsRefs() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
    return retval;
  stop:
...
/* auxiliary function: inserts or updates the Styled Group descriptive infos */
    ...
    if (!exists)
	  ...
	  if (ret == SQLITE_DONE || ret == SQLITE_ROW)
	      ...
	      whu_e ("styledGroupSetInfos() error: \"%s\"\n",
			    sqlite3_errmsg (sqlite));
	  sqlite3_finalize (stmt);
      }
    return retval;
...
/* deleting Group Styles */
	...
	whu_e ("deleteStyledGroup() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
    if (!retval)
	return 0;
...
/* checks if a Styled Group Layer (Raster) do actually exists */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("checkStyledGroupRasterItem: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* checks if a Styled Group Layer (Vector) do actually exists */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("checkStyledGroupVectorItem: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* auxiliary function: really updating a Group Styled Layer Paint Order */
	...
	whu_e ("updatePaintOrder error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
    return retval;
  stop:
...
/* completely removing a Styled Group */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("deleteStyledGroupLayer: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  return 0;
      }
    sqlite3_reset (stmt);
	...
	whu_e ("deleteStyledGroupLayer() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
    return retval;
}
...
/* auxiliary function: checks for an eventual duplicate name */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("GroupStyle duplicate Name: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  return 0;
      }
    sqlite3_reset (stmt);
...
/* auxiliary function: inserts a Group Style definition */
    ...
    if (p_blob != NULL && n_bytes > 0)
	  ...
	  if (ret == SQLITE_DONE || ret == SQLITE_ROW)
	    ...
	    {
		whu_e ("registerGroupStyle() error: \"%s\"\n",
			      sqlite3_errmsg (sqlite));
		sqlite3_finalize (stmt);
		return 0;
	    }
...
/* auxiliary function: deleting all Group Style references */
	...
	whu_e ("unregisterGroupStyle() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
    return retval;
  stop:
...
/* checks if a Group Style do actually exists - by ID */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Group Style Refs by ID: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* checks if a Group Style do actually exists - by name */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Group Style Refs by Name: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* checks if a Group Style do actually exists - by ID */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Group Style by ID: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* checks if a Group Style do actually exists - by name */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Group Style by Name: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* auxiliary function: reloads a Group Style definition */
    ...
    if (p_blob != NULL && n_bytes > 0)
	  ...
	  if (ret == SQLITE_DONE || ret == SQLITE_ROW)
	    ...
	    {
		whu_e ("reloadGroupStyle() error: \"%s\"\n",
			      sqlite3_errmsg (sqlite));
		sqlite3_finalize (stmt);
		return 0;
	    }
...
/* auxiliary function: really inserting a Styled Group Style */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("registerStyledGroupStyle: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
	...
	whu_e ("registerGroupStyledLayer() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
    return retval;
  stop:
...
/* checks if a Styled Group Style do actually exists - by ID */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Styled Group Style by ID: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* checks if a Styled Group Style do actually exists - by name */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Styled Group Style by Name: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* auxiliary function: really deleting a Styled Group Style */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("unregisterStyledGroupStyle: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
	...
	whu_e ("unregisterStyledGroupStyle() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
    return retval;
  stop:
...
/* auxiliary function: inserts a Vector Coverage definition */
	...
	&& f_geometry_column != NULL && title != NULL && abstract != NULL)
	  ...
	  if (ret != SQLITE_OK)
	    {
		whu_e ("registerVectorCoverage: \"%s\"\n",
			      sqlite3_errmsg (sqlite));
		return 0;
	    }
	  sqlite3_reset (stmt);
	  ...
	  if (ret == SQLITE_DONE || ret == SQLITE_ROW)
	    ...
	    {
		whu_e ("registerVectorCoverage() error: \"%s\"\n",
			      sqlite3_errmsg (sqlite));
		sqlite3_finalize (stmt);
		return 0;
	    }
...
/* auxiliary function: deleting a Vector Coverage alternative SRID */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("unregisterVectorCoverageSrid: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  return;
      }
    sqlite3_reset (stmt);
	...
	whu_e ("unregisterVectorCoverageSrid() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
}
...
/* auxiliary function: deleting an Vector Coverage Keyword */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("unregisterVectorCoverageKeyword: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  return;
      }
    sqlite3_reset (stmt);
	...
	whu_e ("unregisterVectorCoverageKeyword() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
}
...
/* auxiliary function: deleting all Vector Coverage Styled references */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("unregisterVectorCoverageStyles: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  return;
      }
    sqlite3_reset (stmt);
	...
	whu_e ("unregisterVectorCoverageStyles() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
}
...
/* auxiliary function: deleting all Vector Coverage Styled Group references */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("unregisterVectorCoverageGroups: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  return;
      }
    sqlite3_reset (stmt);
	...
	whu_e ("unregisterVectorCoverageGroups() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
}
...
/* auxiliary function: deleting a Vector Coverage */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("unregisterVectorCoverage: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
	...
	whu_e ("unregisterVectorCoverage() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
    return retval;
  stop:
...
/* auxiliary function: updates the descriptive infos supporting a Vector Coverage */
    ...
    if (coverage_name != NULL && title != NULL && abstract != NULL)
	  ...
	  if (ret == SQLITE_DONE || ret == SQLITE_ROW)
	    ...
	    {
		whu_e ("setVectorCoverageInfos() error: \"%s\"\n",
			      sqlite3_errmsg (sqlite));
		sqlite3_finalize (stmt);
		return 0;
	    }
...
/* checks if a Vector Coverage SRID do actually exists */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Vector Coverage SRID: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* auxiliary function: inserting a Vector Coverage alternative SRID */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("registerVectorCoverageSrid: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  return 0;
      }
    sqlite3_reset (stmt);
	...
	;
      ...
      {
	  whu_e ("registerVectorCoverageSrid() error: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  sqlite3_finalize (stmt);
	  return 0;
      }
...
/* checks if a Vector Coverage do actually exists */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Vector Coverage Keyword: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* auxiliary function: inserting a Vector Coverage Keyword */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("registerVectorCoverageKeyword: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  return 0;
      }
    sqlite3_reset (stmt);
	...
	;
      ...
      {
	  whu_e ("registerVectorCoverageKeyword() error: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  sqlite3_finalize (stmt);
	  return 0;
      }
...
/* setting the main Coverage Extent to NULL */
	...
	;
      ...
      {
	  whu_e ("updateVectorCoverageExtent error: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  return 0;
      }
...
/* preparing the ancillary SQL statements */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("updateVectorCoverageExtent: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto error;
      }
...
/* checks if a Raster Coverage SRID do actually exists */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Raster Coverage SRID: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* auxiliary function: inserting a Raster Coverage alternative SRID */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("registerRasterCoverageSrid: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  return 0;
      }
    sqlite3_reset (stmt);
	...
	;
      ...
      {
	  whu_e ("registerRasterCoverageSrid() error: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  sqlite3_finalize (stmt);
	  return 0;
      }
...
/* auxiliary function: deleting all Raster Coverage alternative SRIDs */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("unregisterRasterCoverageSrid: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  return;
      }
    sqlite3_reset (stmt);
	...
	whu_e ("unregisterRasterCoverageSrid() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
}
...
/* checks if a Raster Coverage do actually exists */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("check Raster Coverage Keyword: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto stop;
      }
    sqlite3_reset (stmt);
...
/* auxiliary function: inserting a Raster Coverage Keyword */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("registerRasterCoverageKeyword: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  return 0;
      }
    sqlite3_reset (stmt);
	...
	;
      ...
      {
	  whu_e ("registerRasterCoverageKeyword() error: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  sqlite3_finalize (stmt);
	  return 0;
      }
...
/* auxiliary function: deleting all Raster Coverage Keyword */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("unregisterRasterCoverageKeyword: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  return;
      }
    sqlite3_reset (stmt);
	...
	whu_e ("unregisterRasterCoverageKeyword() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
}
...
/* setting the main Coverage Extent to NULL */
	...
	;
      ...
      {
	  whu_e ("updateRasterCoverageExtent error: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  return 0;
      }
/* setting all alternativ Coverage Extent to NULL */
...
/* preparing the ancillary SQL statements */
    ...
    if (ret != SQLITE_OK)
      {
	  whu_e ("updateRasterCoverageExtent: \"%s\"\n",
			sqlite3_errmsg (sqlite));
	  goto error;
      }
...
/* auxiliary function: inserts or updates an ISO Metadata */
	...
	whu_e ("registerIsoMetadata() error: \"%s\"\n",
		      sqlite3_errmsg (sqlite));
    sqlite3_finalize (stmt);
    return retval;
  stop:
