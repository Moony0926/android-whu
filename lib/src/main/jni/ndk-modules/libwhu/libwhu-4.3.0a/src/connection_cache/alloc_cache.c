...
#include <whu/gg_advanced.h>
#include <whu/gaiamatrix.h>
...
{
    int i;
    for (i = 0; i < WHU_MAX_CONNECTIONS; i++)
      {
    ...
    whu_e ("ERROR: Too many connections: max %d\n",
		  WHU_MAX_CONNECTIONS);
    return -1;
}
