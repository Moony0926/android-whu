...
/ auto_epsg
/
/ a tool autogenerating C code for Whu
...
/* writing a file header */
    ...
    fprintf (out, "#include <whu_private.h>\n\n");
...
/* function header */
    ...
    for (i = 0; i < sect; i++)
	fprintf (out,
		 "WHU_PRIVATE void initialize_epsg_%02d (\n\tint filter, struct epsg_defs **first, struct epsg_defs **last);\n",
		 i);
    for (i = 0; i < wgs84_sect; i++)
	fprintf (out,
		 "WHU_PRIVATE void initialize_epsg_wgs84_%02d (\n\tint filter, struct epsg_defs **first, struct epsg_defs **last);\n",
		 i);
    fprintf (out,
	     "WHU_PRIVATE void initialize_epsg_prussian (\n\tint filter, struct epsg_defs **first, struct epsg_defs **last);\n");
    fprintf (out,
	     "WHU_PRIVATE void initialize_epsg_extra (\n\tint filter, struct epsg_defs **first, struct epsg_defs **last);\n\n");
