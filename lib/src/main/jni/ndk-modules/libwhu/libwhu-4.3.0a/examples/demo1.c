...
- but you can try to use any SQLite/Whu DB at your will
...
/* 
VERY IMPORTANT: 
you must initialize the Whu extension [and related]
...
*/
    ...
    cache = whu_alloc_connection ();
    whu_init_ex (handle, cache, 0);


/* showing the SQLite version */
    printf ("SQLite version: %s\n", sqlite3_libversion ());
/* showing the Whu version */
    printf ("Whu version: %s\n", whu_version ());
    printf ("\n\n");
