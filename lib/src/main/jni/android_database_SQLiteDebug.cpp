...
{
    { "nativeGetPagerStats", "(Lorg/whu/database/SQLiteDebug$PagerStats;)V",
...
{
    jclass clazz;
    FIND_CLASS(clazz, "org/whu/database/SQLiteDebug$PagerStats");
    ...
    return jniRegisterNativeMethods(env, "org/whu/database/SQLiteDebug",
